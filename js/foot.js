...
$(document).ready(function(e){
    $('.copyright').html('©2023 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By 薛定谔的喵');
})
...
$('.framework-info').html('小破站已经安全运行<span id="span_dt_dt"></span>');
window.setTimeout("show_date_time()", 1000);
BirthDay=new Date("6/7/2018 0:0:0");
today=new Date();
